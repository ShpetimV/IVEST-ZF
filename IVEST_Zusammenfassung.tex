...
{\centering\includegraphics[width=\linewidth]{imgages/erfolgsrechnung.png}\par}
...
{\centering\includegraphics[width=\linewidth]{imgages/geldflussrechnung_direkt.png}\par}
...
{\centering\includegraphics[width=\linewidth]{imgages/geldflussrechnung_indirekt.png}\par}

\K{Gesamte Geldflussrechnung}\\
{\centering\includegraphics[width=\linewidth]{imgages/geldflussrechnung_gesamt.png}\par}
{\centering\includegraphics[width=0.7\linewidth]{imgages/liquiditaetsnachweis.png}\par}

\sechead{Finanzierung — Grundlagen}
{\centering\includegraphics[width=\linewidth]{imgages/finanzierung.png}\par}
...
\begin{minipage}{19.8cm}
  ...
  \includegraphics[width=\linewidth]{imgages/abzinsungsfaktoren.png}\par\vspace{1cm}
  \K{Rentenbarwertfaktoren (RBF) Tabelle B}\\[4pt]
  \includegraphics[width=\linewidth]{imgages/rentenbarwertfaktoren.png}
\end{minipage}
\end{document}
