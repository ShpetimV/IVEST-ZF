...
$RG$ = Reingewinn, nicht-lw = nicht liquiditätswirksame Posten,
$\Delta\text{Akt.}$ = Veränderung Aktiven (UV), $\Delta\text{Pass.}$ = Veränderung Passiven (kurzfr.\ FK).\\
\K{Anlagespiegelformel}:\\
\fb{AB-\text{Abschr.}+\text{Inv.}-\text{Desinv.}=SB}\\
$AB$ = Anfangsbestand, $SB$ = Schlussbestand, Inv.\ = Investitionen, Desinv.\ = Desinvestitionen.\\

{\centering\includegraphics[width=\linewidth]{images/geldflussrechnung_indirekt.png}\par}

\K{Gesamte Geldflussrechnung}\\
{\centering\includegraphics[width=\linewidth]{images/geldflussrechnung_gesamt.png}\par}
{\centering\includegraphics[width=0.7\linewidth]{images/liquiditaetsnachweis.png}\par}
